...
\end{figure}
\clearpage
\paragraph{\textit{Third-party user}} The scheme above represents the main desktop screens and the way -condition and action needed- how the third-party user can move trough them.
\begin{figure}[H]
