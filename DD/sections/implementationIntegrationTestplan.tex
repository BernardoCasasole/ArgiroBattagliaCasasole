...
\begin{itemize}
\item \textbf{JUnit} - can be used in order to verify assertions on return values after method invocations.
\item \textbf{Mockito} - a mocking framework for unit tests which can be used in order to perform scaffolding activity.
